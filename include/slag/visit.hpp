...
namespace slag {
    ...
    constexpr inline void visit(Visitor&& visitor, T& value) {
        visitor.enter(value);
        visitor.leave(value);
    }
    ...
    template<typename Visitor, typename T>
    constexpr inline void visit(Visitor&& visitor, std::optional<T>& value) {
        visitor.enter(value);
        if (value) {
            visit(visitor, *value);
        }
    ...
    constexpr inline void visit(Visitor&& visitor, std::pair<T1, T2>& value) {
        visitor.enter(value);
        {
    ...
    constexpr inline void visit(Visitor&& visitor, std::tuple<Types...>& value) {
        visitor.enter(value);
        {
    ...
    template<typename Visitor, typename... Types>
    constexpr inline void visit(Visitor&& visitor, std::variant<Types...>& value) {
        visitor.enter(value);
    ...
    template<typename Visitor, typename T>
    constexpr inline void visit(Visitor&& visitor, std::vector<T>& value) {
        visitor.enter(value);
    ...
    constexpr inline void visit(Visitor&& visitor, std::unordered_map<Key, T>& value) {
        visitor.enter(value);
        for (auto&& element: value) {
